...
<div class="container-fluid px-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-end">
            <span class="badge bg-secondary p-2"><i class="fas fa-calendar-day me-1"></i> <?php echo date('d/m/Y'); ?></span>
        </div>
    </div>
    ...
    <!-- 2. 第二排指标：财务业绩与库存警戒 (采用高自适应5列栅格结构) -->
    <div class="row g-3 mb-4">
        <!-- 今日营业额 -->
            ...
            <div class="card border-0 shadow-sm h-100 p-3 text-white bg-success rounded-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-bold mb-0">RM <?php echo number_format($today_sales, 2); ?></h4>
                    </div>
                    <i class="fas fa-coins fa-lg text-white-50"></i>
                </div>
            </div>
        </div>
        <!-- 本周营业额 -->
            ...
            <div class="card border-0 shadow-sm h-100 p-3 text-white bg-warning text-dark rounded-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-bold mb-0">RM <?php echo number_format($weekly_sales, 2); ?></h4>
                    </div>
                    <i class="fas fa-calendar-week fa-lg text-dark-50 opacity-50"></i>
                </div>
            </div>
        </div>
        <!-- 本月营业额 -->
            ...
            <div class="card border-0 shadow-sm h-100 p-3 text-white bg-primary rounded-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-bold mb-0">RM <?php echo number_format($monthly_sales, 2); ?></h4>
                    </div>
                    <i class="fas fa-chart-bar fa-lg text-white-50"></i>
                </div>
            </div>
        </div>
        <!-- 累计总营收 (All-Time Revenue) -->
        <div class="col-6 col-md-6 col-xl">
            <div class="card border-0 shadow-sm h-100 p-3 text-white bg-dark rounded-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <small class="text-white-50 d-block"><?php echo $l['dash_all_time_revenue'] ?? 'All-Time Revenue'; ?></small>
                        <h4 class="fw-bold mb-0">RM <?php echo number_format($total_sales, 2); ?></h4>
                    </div>
                    <i class="fas fa-sack-dollar fa-lg text-white-50"></i>
                </div>
            </div>
        </div>
        <!-- 低库存警戒 -->
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted" style="font-size: 0.75rem;"><?php echo date('d/m/Y H:i', strtotime($act['date'])); ?></small>
                                        </div>
                                    </div>
